 ...
 * Originally written by: bnr hack
 * Website: Info Blog (http://bnrhack.blogspot.com)
 * On 07th april 2009
 *
...
function hn_writeContent(){
    ...
    s += "  <img src='http://4vector.com/i/free-vector-headline-news-logo_091376_Headline_NEWS_logo.png'";
    s += " height='20'/>";
    s += " </a>";
    s += "</div>";
    if(hn_tampilkan_judul){
        s += "  <div style='float:left; font-size:10px; text-align:right; margin-left:10px;'>";
        s += "    <a href='http://bloggernias.blogspot.com'>Artikel Terbaru</a>";
        s += "  </div>";
    }
    ...
    if(hn_backlink == true | hn_backlink == undefined){
        ...
        s += "  Widget by ";
        s += "  <a href='http://bloggernias.blogspot.com/'>";
        s += "    bloggernias";
        s += "  </a>";
        s += "</div>";
    }
